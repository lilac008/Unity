...
public class WeaponManager : MonoBehaviour
{
    ...
    {
        SetWeaponType(WeaponType.Bullet0);      ///ÃÊ±âÈ­
    ...
    {
        SetWeaponType(WeaponType.Bullet0);        ///myBullet.SetWeapon(new Bullet0());
    }

    public void ChangeToBullet1() ///ÃÑ¾Ë 2¹ß
    {
        SetWeaponType(WeaponType.Bullet1);       ///myBullet.SetWeapon(new Bullet1());
    }


    public void Fire(GameObject player) 
    {
        weapon.Shoot(myBullet, player);         ///myBullet.Shoot();
    }
