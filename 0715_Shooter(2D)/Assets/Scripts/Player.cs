...
public class Player : MonoBehaviour
{
    ...
    public bool isTouchTop = false;         /// Border
    ...
    void Fire()///총 쏘는 로직
    {
        ...
        GameObject bullet = objectManager.MakeObject("PlayerBullet"); ///GameObject bullet = Instantiate(goBullet, transform.position, Quaternion.identity);
