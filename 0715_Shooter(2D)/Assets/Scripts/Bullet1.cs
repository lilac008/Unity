...
using UnityEngine;    ///  만일 MonoBehaviour을 상속하지 않을 경우 이 선언은 제외된다.
...
public class Bullet1 : MonoBehaviour, IWeapon    /// 2발 총알 skript  /  IWeapon 상속 : start(), update()를 삭제한 후 public void Shoot() 정의하면 빗금이 사라진다.
{
